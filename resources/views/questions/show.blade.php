                    ...
                    <div class="actions">
                        @if(Auth::check() && Auth::user()->owns($question))
                            ...
                            <form action="/questions/{{ $question->id }}" method="POST" class="delete-form">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                                <button class="button button-delete is-naked">删除</button>
                            </form>
                        @endif
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="/questions/{{ $question->id }}/answer" method="post">
                            ...
                            <button class="btn btn-success pull-right">提交回答</button>
                        </form>
                        @else
                                <a href="/login" class="btn btn-success btn-block">登陆提交答案</a>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="media">
                            ...
                            ></user-follow-button>
                            <send-message class="pull-right" user="{{ $question->user_id }}"></send-message>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        ue.ready(function() {
            ue.execCommand('serverparam', '_token', Laravel.csrf_token); // 设置 CSRF token.
        });
